...
public class PitchFactory {
	...
	protected PitchFactory(Team... teams) {
		this(Companion.getDEFAULT_PITCH_NAME(), Companion.getDEFAULT_WIDTH(), Companion.getDEFAULT_HEIGHT(),
				Companion.getDEFAULT_WIDE_ZONE(), teams);
	}
	...
	public static Pitch getPitch(Team... teams) {
		...
		String pitchType = Companion.getDEFAULT_PITCH_TYPE();
		return Companion.getPitch(pitchType, teams);
	}
