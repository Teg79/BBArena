...
public class RangeRuler {
	...
	protected static final double RULER_WIDTH_RATIO = Companion.getRULER_WIDTH()
			/ Square.Companion.getSQUARE_WIDTH();
	...
	private boolean isInterceptable(Coordinate from, Coordinate to,
		...
		if (b < a && c < a
				&& getDistanceFromThrowLine(a, b, c) <= Companion.getRULER_WIDTH_RATIO()) {
			res = true;
		}
