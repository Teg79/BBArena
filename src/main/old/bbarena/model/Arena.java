...
public class Arena implements Serializable {
	...
	private Weather _weather = Weather.Companion.getWeather(Weather.WeatherType.NICE);
	...
	public Arena(Match match, String pitchType, Team... teams) {
		...
		if (pitchType == null || pitchType.trim().length() == 0) {
			...
			_pitch = PitchFactory.Companion.getPitch(teams);
		} else {
			_log.debug("Creating " + pitchType + " pitch...");
			_pitch = PitchFactory.Companion.getPitch(pitchType, teams);
		}
